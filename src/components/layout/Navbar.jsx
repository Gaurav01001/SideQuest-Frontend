            ...
            <div className="relative">
              ...
              {dropdownOpen && (
                <>
                  ...
                  />
                  <div className="absolute right-0 mt-2 w-48 rounded-[12px] bg-white dark:bg-[#1E1E1B] border border-[#E8E6E1] dark:border-[#312F2C] shadow-md py-1 z-50">
                    ...
                    <button
                      ...
                      className="w-full text-left px-4 py-2.5 text-sm text-[#EF4444] hover:bg-[#F5F4F1] dark:hover:bg-[#272724] transition-colors flex items-center gap-2 font-medium"
                    >
