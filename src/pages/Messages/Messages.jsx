    ...
    <div className="min-h-screen bg-[#FAFAF8] dark:bg-[#141412] text-[#1A1916] dark:text-[#F0EEE9] transition-colors duration-200">
      ...
      <div className="flex">
        ...
        <main className="flex-1 flex gap-4 h-[calc(100vh-68px)] p-4 max-w-7xl mx-auto overflow-hidden">
          ...
          {/* Conversations Panel */}
          <div className="w-72 sm:w-80 flex-shrink-0 bg-white dark:bg-[#1E1E1B] rounded-[16px] border border-[#E8E6E1] dark:border-[#312F2C] p-4 flex flex-col shadow-xs overflow-hidden">
          ...
          <div className="flex-1 bg-white dark:bg-[#1E1E1B] rounded-[16px] border border-[#E8E6E1] dark:border-[#312F2C] flex flex-col shadow-xs overflow-hidden">
            
            {/* Conversation Header */}
            <div className="border-b border-[#E8E6E1] dark:border-[#312F2C] p-4 flex items-center gap-3 bg-white dark:bg-[#1E1E1B]">
              {selectedConvos ? (
                <>
                  <div className="relative">
                    <img 
                      ...
                      className="w-9 h-9 rounded-full bg-gray-100 dark:bg-gray-800 object-cover border border-[#E8E6E1] dark:border-[#312F2C]"
                    />
